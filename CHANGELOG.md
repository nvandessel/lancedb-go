...
### Note
- `DistanceType` was removed in v0.2.0 because the Rust FFI did not support it. It was re-added in v0.3.0 with full FFI wiring — the removal entries have been superseded.
